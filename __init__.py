...
class ClassroomApp:
    def __init__(self, master=None):
        ...
        #Butonlara icon ekle
        self.add_icon = tk.PhotoImage(file=str(ICON_PATH / 'add.png'))
        self.remove_icon = tk.PhotoImage(file=str(ICON_PATH / 'remove.png'))
        self.search_icon = tk.PhotoImage(file=str(ICON_PATH / 'search.png'))
        self.remove_student_icon = tk.PhotoImage(file=str(ICON_PATH / 'deletestudent.png'))
        self.add_student_icon = tk.PhotoImage(file=str(ICON_PATH / 'addstudent.png'))
        self.edit_student_icon = tk.PhotoImage(file=str(ICON_PATH / 'editstudent.png'))
        self.select_today_icon = tk.PhotoImage(file=str(ICON_PATH / 'today.png'))
